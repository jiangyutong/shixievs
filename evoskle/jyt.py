...
def load_data(filepath):
    ...
    return x
a=load_data("/media/zlz422/82BEDFE2BEDFCD33/jyt/project/EvSkeleton/data/human3.6M/jyt_gennet_random_vail66.npy")
# a=np.load("/media/zlz422/82BEDFE2BEDFCD33/jyt/project/EvSkeleton/data/human3.6M/jyt_gennet_random_vail66.npy",allow_pickle=True)
print("")
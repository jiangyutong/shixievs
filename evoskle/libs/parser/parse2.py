...
def parse_arg():
    ...
    parser.add_argument('-evolved_path', type=str, default="/media/zlz422/82BEDFE2BEDFCD33/jyt/project/EvSkeleton/data/human3.6M/jyt_gennet_random_vail5.npy")
    ...
    parser.add_argument('-momentum', type=float, default=0.5, help="sgd: 0.9")

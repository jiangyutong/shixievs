...
def parse_arg():
    ...
    parser.add_argument('-data_dir_cvae', type=str, default='../../data/human3.6M/')
    ...
    parser.add_argument('-evolved_path', type=str, default="/media/zlz422/82BEDFE2BEDFCD33/jyt/project/EvSkeleton/data/human3.6M/jyt_gennet_random_vail4.npy")

...
class FCModel(nn.Module):
    def __init__(self,
        ...
        self.wlstm = nn.Linear(self.input_size*4*64, self.output_size)
        ...
        self.lstm2 = nn.RNN(2, 256, batch_first=True, bidirectional=True, num_layers=3,dropout=0.5)
    ...
    def forward(self, x):
        ...
        h0 = torch.randn(6, mysize, 256).cuda()

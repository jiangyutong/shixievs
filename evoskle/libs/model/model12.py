...
class FCModel(nn.Module):
    def __init__(self,
        ...
        self.wlstm = nn.Linear(self.input_size*32, self.output_size)
        ...
        self.lstm2 = nn.LSTM(2, 64, batch_first=True, bidirectional=False, num_layers=2,dropout=0.5)
    ...
    def forward(self, x):
        ...
        h0 = torch.randn(2, mysize, 64).cuda()
        c0 = torch.randn(2, mysize, 64).cuda()

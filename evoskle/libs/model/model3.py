...
class FCModel(nn.Module):
    def __init__(self,
        ...
        # self.w1 = nn.Linear(64, self.linear_size)
        self.batch_norm1 = nn.BatchNorm1d(self.linear_size)
        self.res_blocks1 = ResidualBlock(self.input_size,
                                        self.p_dropout,
                                        leaky=self.leaky)
        self.connv1d = nn.Conv1d(in_channels=17, out_channels=17, stride=1, kernel_size=1, padding=0)
        self.res_blocks = []

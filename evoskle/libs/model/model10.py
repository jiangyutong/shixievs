...
class FCModel(nn.Module):
    def __init__(self,
        ...
        self.wlstm = nn.Linear(self.input_size*32*8, self.output_size)
        ...
        self.lstm2 = nn.LSTM(2, 256, batch_first=True, bidirectional=True, num_layers=2,dropout=0.3)
    ...
    def forward(self, x):
        ...
        h0 = torch.randn(4, mysize, 256).cuda()
        c0 = torch.randn(4, mysize, 256).cuda()

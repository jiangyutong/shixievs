...
def get_dict_2d(train_dict_3d, test_dict_3d, rcams, ncams, opt):
    ...
    mymodel = model.get_model(
                              ...
                              dropout=opt.dropout,
                              leaky=opt.leaky)
    # mymodel = torch.load('/media/zlz422/82BEDFE2BEDFCD33/jyt/project/EvSkeleton/data/human3.6M/2021-10-29 12:27:47.671742_jyt_fine_2d/model')

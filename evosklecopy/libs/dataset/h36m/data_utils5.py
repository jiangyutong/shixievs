...
def get_dict_2d(train_dict_3d, test_dict_3d, rcams, ncams, opt):
    ...
    dataloader2 = DataLoader(dataset=deal_dataset2, batch_size=256, shuffle=True,pin_memory=True,num_workers=32)
    ...
    for batch_idx in range(1, epochs + 1):
        ...
        #     print("Epoch:{} LossAll：{} Loss：{} ".format(batch_idx, lossall/iteration, loss))
            # print("Epoch:{} Loss：{}  ".format(batch_idx, lossall))
        # else:
            # for i, (data_targ, data_train,threeDcameras,f,c) in enumerate(dataloader2):
        prefetcher = DataPrefetcher(dataloader2)
        data_targ, data_train, threeDcameras, f, c = prefetcher.next()

...
class FCModel(nn.Module):
    def __init__(self,
        ...
        self.wlstm = nn.Linear(self.input_size*256*4, self.output_size)
        ...
        self.lstm2 = nn.LSTM(2, 1024, batch_first=True, bidirectional=True, num_layers=1,dropout=0.3)
    ...
    def forward(self, x):
        ...
        h0 = torch.randn(2, mysize, 1024).cuda()
        c0 = torch.randn(2, mysize, 1024).cuda()

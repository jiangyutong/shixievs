...
def parse_arg():
    ...
    # Mutation rate of changing global skeleton orientation 0.1
    ...
    # Threshold for valid bone vector 9
    ...
    parser.add_argument('-SN', type=str, default='cvae3')
    ...
    parser.add_argument('-SD', type=str, default='../data/human3.6M/siting_sittingdown_photo_th=8')
    parser.add_argument('-Sp', type=str,
                        default='siting_sittingdown_photo_th=8')
    ##-----------------------------------------------------------------------##
    ## Usages    
    # Usage: generate data
